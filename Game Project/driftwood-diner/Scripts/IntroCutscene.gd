...
func _play_sequence() -> void:
	...
	tween.tween_property(fader, "color:a", 1.0, 1.5)
	...
	tween.tween_property(texture_rect, "modulate", Color.WHITE, 0.8).set_ease(Tween.EASE_OUT).set_trans(Tween.TRANS_CUBIC)
